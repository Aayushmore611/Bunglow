! function(t, e) {
    ...
    function n(t, e) {
        ...
        return Ke(t).reduce(function(n, r) {
            return e(n, t[r], r)
        }, n)
    }
    ...
    function i(t) {
        return !!t && "object" === (void 0 === t ? "undefined" : Ve(t))
    }
    ...
    function a(t, e) {
        if (!t || !e) return "";
        if ("function" == typeof pe.getComputedStyle) {
            var n = pe.getComputedStyle(t);
            return n ? n[e] : ""
        }
    ...
    function h() {
        return ge === pe.document && void 0 !== ge.createElement
    }
    ...
    function f(t) {
        return function(e, n) {
            if (!l(e)) return ge[t](null);
            l(n) && (n = ge.querySelector(n));
            var r = p(n) ? n : ge;
            return r[t] && r[t](e)
        }
    }
    ...
    function v() {
        ...
        return Object.getOwnPropertyNames(e).forEach(function(t) {
            var n = e[t]; - 1 !== t.indexOf("aria-") || "role" === t || "type" === t ? (Qe.warn(Ze(tn, t, n)), i.setAttribute(t, n)) : "textContent" === t ? y(i, n) : i[t] = n
    ...
    function P(t) {
        ...
        var n = ge.documentElement,
            r = ge.body,
            i = n.clientLeft || r.clientLeft || 0,
            o = pe.pageXOffset || r.scrollLeft,
            s = e.left + o - i,
            a = n.clientTop || r.clientTop || 0,
            l = pe.pageYOffset || r.scrollTop,
            c = e.top + l - a;
        return {
            left: Math.round(s),
            top: Math.round(c)
    ...
    function I(t) {
        return "function" == typeof t && (t = t()), (Array.isArray(t) ? t : [t]).map(function(t) {
            return "function" == typeof t && (t = t()), p(t) || M(t) ? t : "string" == typeof t && /\S/.test(t) ? ge.createTextNode(t) : void 0
        }).filter(function(t) {
            return t
        })
    }
    ...
    function F(t) {
        var e = t[an];
        return e || (e = t[an] = B()), sn[e] || (sn[e] = {}), sn[e]
    }

    function H(t) {
        var e = t[an];
        return !!e && !!Object.getOwnPropertyNames(sn[e]).length
    }
    ...
    function V(t) {
        ...
        if (e) {
            ...
            try {
                ...
                t.removeAttribute ? t.removeAttribute(an) : t[an] = null
            }
        }
    }
    ...
    function U(t) {
        ...
        if (!t || !t.isPropagationStopped) {
            ...
            if (t.target || (t.target = t.srcElement || ge), t.relatedTarget || (t.relatedTarget = t.fromElement === t.target ? t.toElement : t.fromElement), t.preventDefault = function() {
    ...
    function K(t, e, n) {
        ...
        if ("string" == typeof e && (e = {
                type: e,
                target: t
            }), e = U(e), r.dispatcher && r.dispatcher.call(t, e, n), i && !e.isPropagationStopped() && !0 === e.bubbles) K.call(null, i, e, n);
    ...
    function $(t) {
        ...
        return r(t, xn), t.on("dispose", function() {
            t.off(), pe.setTimeout(function() {
                t.eventBusEl_ = null
            }, 0)
        }), t
    }
    ...
    function J(t, e) {
        return r(t, jn), t.state = r({}, t.state, e), "function" == typeof t.handleStateChanged && bn(t) && t.on("statechanged", t.handleStateChanged), t
    }
    ...
    function ht(t, e, n) {
        if (!cr(e)) throw new TypeError("iterator must be a function");
        arguments.length < 3 && (n = this), "[object Array]" === dr.call(t) ? pt(t, e, n) : "string" == typeof t ? dt(t, e, n) : ft(t, e, n)
    }

    function pt(t, e, n) {
        for (var r = 0, i = t.length; r < i; r++) fr.call(t, r) && e.call(n, t[r], r, t)
    }
    ...
    function ft(t, e, n) {
        for (var r in t) fr.call(t, r) && e.call(n, t[r], r, t)
    }

    function vt() {
        for (var t = {}, e = 0; e < arguments.length; e++) {
            var n = arguments[e];
            for (var r in n) mr.call(n, r) && (t[r] = n[r])
        }
        return t
    }
    ...
    function gt(t, e, n) {
        var r = t;
        return cr(e) ? (n = e, "string" == typeof t && (r = {
            uri: t
        })) : r = gr(e, {
            uri: t
        }), r.callback = n, r
        ...
        function i() {
            if (!c) {
                ...
                return 0 !== e ? (r = {
                    ...
                    url: h,
                    rawRequest: a
                }, a.getAllResponseHeaders && (r.headers = yr(a.getAllResponseHeaders()))) : i = new Error("Internal XMLHttpRequest Error"), s(i, r, r.body)
            }
        }
    ...
    function xt(t, e) {
        ...
        for (var r, i = t.document.createElement("div"), o = i, s = []; null !== (r = function() {
            ...
            if ("<" !== r[0]) o.appendChild(t.document.createTextNode(function(t) {
                ...
                if (! function(t, e) {
                        return !Dr[e.localName] || Dr[e.localName] === t.localName
                    }(o, a)) continue;
    ...
    function Ft(t, e, n) {
        ...
        if (Object.defineProperty(r, "id", Bt({}, o, {
                ...
                set: function(t) {
                    if ("number" != typeof t && t !== Br) throw new SyntaxError("An invalid number or illegal string was specified.");
    ...
    function Ht(t) {
        return "string" == typeof t && (!!zr[t.toLowerCase()] && t.toLowerCase())
    }
    ...
    function Ut(t, e) {
        qr[t] = qr[t] || [], qr[t].push(e)
    }

    function Xt(t, e, n) {
        t.setTimeout(function() {
            return te(e, qr[e.type], n, t)
        }, 1)
    }
    ...
    function Zt(t, e) {
        var n = Kr[t.id()],
            r = null;
        if (void 0 === n || null === n) return r = e(t), Kr[t.id()] = [
            [e, r]
        ], r;
    ...
    function te() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
            ...
            a = e[0],
            l = e.slice(1);
        if ("string" == typeof a) te(t, qr[a], n, i, o, s);
        else if (a) {
            var c = Zt(i, a);
            c.setSource(r({}, t), function(e, r) {
                if (e) return te(t, l, n, i, o, s);
                o.push(c), te(r, t.type === r.type ? l : qr[r.type], n, i, o, s)
            })
        } else l.length ? te(t, l, n, i, o, s) : s ? n(t, o) : te(t, qr["*"], n, i, o, !0)
    }
    ...
    function ae(t, e, n) {
        var r = ae.getPlayer(t);
        if (r) return e && Qe.warn('Player "' + t + '" is already initialised. Options will not be applied.'), n && r.ready(n), r;
        var o = "string" == typeof t ? en("#" + Io(t)) : t;
        if (!p(o)) throw new TypeError("The element or ID supplied is not valid. (videojs)");
        ge.body.contains(o) || Qe.warn("The element supplied is not included in the DOM"), e = e || {}, ae.hooks("beforesetup").forEach(function(t) {
            var n = t(o, tt(e));
            if (!i(n) || Array.isArray(n)) return void Qe.error("please return an object in beforesetup hooks");
            e = tt(e, n)
        });
        var s = An.getComponent("Player");
        return r = new s(o, e, n), ae.hooks("setup").forEach(function(t) {
            return t(r)
        }), r
    }
    var le, ce = "6.7.3",
        ue = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {};
    le = "undefined" != typeof window ? window : void 0 !== ue ? ue : "undefined" != typeof self ? self : {};
    var he, pe = le,
        de = {},
        ...
        ve = fe && de || fe,
        ye = void 0 !== ue ? ue : "undefined" != typeof window ? window : {};
    "undefined" != typeof document ? he = document : (he = ye["__GLOBAL_DOCUMENT_CACHE@4"]) || (he = ye["__GLOBAL_DOCUMENT_CACHE@4"] = ve);
    var ge = he,
        me = pe.navigator && pe.navigator.userAgent || "",
        _e = /AppleWebKit\/([\d.]+)/i.exec(me),
        be = _e ? parseFloat(_e.pop()) : null,
        Te = /iPad/i.test(me),
        Ce = /iPhone/i.test(me) && !Te,
        ke = /iPod/i.test(me),
        we = Ce || Te || ke,
        Ee = function() {
            var t = me.match(/OS (\d+)_/i);
            return t && t[1] ? t[1] : null
        }(),
        Se = /Android/i.test(me),
        xe = function() {
            var t = me.match(/Android (\d+)(?:\.(\d+))?(?:\.(\d+))*/i);
            if (!t) return null;
            var e = t[1] && parseFloat(t[1]),
                n = t[2] && parseFloat(t[2]);
            return e && n ? parseFloat(t[1] + "." + t[2]) : e || null
        }(),
        je = Se && /webkit/i.test(me) && xe < 2.3,
        Ae = Se && xe < 5 && be < 537,
        Pe = /Firefox/i.test(me),
        Oe = /Edge/i.test(me),
        Me = !Oe && /Chrome/i.test(me),
        Ne = function() {
            var t = me.match(/Chrome\/(\d+)/);
            return t && t[1] ? parseFloat(t[1]) : null
        }(),
        Ie = /MSIE\s8\.0/.test(me),
        De = function() {
            var t = /MSIE\s(\d+)\.\d/.exec(me),
                e = t && parseFloat(t[1]);
            return !e && /Trident\/7.0/i.test(me) && /rv:11.0/.test(me) && (e = 11), e
        }(),
        Le = /Safari/i.test(me) && !Me && !Se && !Oe,
        Re = Le || we,
        Be = h() && ("ontouchstart" in pe || pe.DocumentTouch && pe.document instanceof pe.DocumentTouch),
        Fe = h() && "backgroundSize" in pe.document.createElement("video").style,
        He = (Object.freeze || Object)({
            ...
            IS_ANY_SAFARI: Re,
            TOUCH_ENABLED: Be,
            BACKGROUND_SIZE_SUPPORTED: Fe
        }),
        Ve = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
            return typeof t
        } : function(t) {
        ...
        $e = [],
        Je = function(t, e) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : !!De && De < 11,
                r = Ye.levels[Ge],
                o = new RegExp("^(" + r + ")$");
            if ("log" !== t && e.unshift(t.toUpperCase() + ":"), $e && $e.push([].concat(e)), e.unshift("VIDEOJS:"), pe.console) {
                var s = pe.console[t];
                s || "debug" !== t || (s = pe.console.info || pe.console.log), s && r && o.test(t) && (n && (e = e.map(function(t) {
                    ...
                    return String(t)
                }).join(" ")), s.apply ? s[Array.isArray(e) ? "apply" : "call"](pe.console, e) : s(e))
            }
        };
    Ye = function() {
        ...
        if ("string" == typeof t) {
            if (!Ye.levels.hasOwnProperty(t)) throw new Error('"' + t + '" in not a valid log level');
            Ge = t
        }
        return Ge
    }, Ye.history = function() {
        return $e ? [].concat($e) : []
    }, Ye.history.clear = function() {
        $e && ($e.length = 0)
    }, Ye.history.disable = function() {
        null !== $e && ($e.length = 0, $e = null)
    }, Ye.history.enable = function() {
        null === $e && ($e = [])
    }, Ye.error = function() {
        for (var t = arguments.length, e = Array(t), n = 0; n < t; n++) e[n] = arguments[n];
        return Je("error", e)
    ...
    var cn = ["touchstart", "touchmove"],
        ...
        dn = function() {
            if (h()) {
                var t = ge.getElementsByTagName("video"),
                    e = ge.getElementsByTagName("audio"),
                    n = ge.getElementsByTagName("video-js"),
                    r = [];
                if (t && t.length > 0)
    ...
    h() && "complete" === ge.readyState ? hn = !0 : Y(pe, "load", function() {
        hn = !0
    });
    var fn = function(t) {
        ...
        mn = function(t, e, n) {
            var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : pe,
                i = void 0;
            return function() {
                var o = this,
                    s = arguments,
        ...
        _n = function() {};
    _n.prototype.allowedEvents_ = {}, _n.prototype.on = function(t, e) {
        var n = this.addEventListener;
        this.addEventListener = function() {}, X(this, t, e), this.addEventListener = n
    }, _n.prototype.addEventListener = _n.prototype.on, _n.prototype.off = function(t, e) {
        q(this, t, e)
    }, _n.prototype.removeEventListener = _n.prototype.off, _n.prototype.one = function(t, e) {
        var n = this.addEventListener;
        this.addEventListener = function() {}, Y(this, t, e), this.addEventListener = n
    }, _n.prototype.trigger = function(t) {
        var e = t.type || t;
        "string" == typeof t && (t = {
            type: e
        }), t = U(t), this.allowedEvents_[e] && this["on" + e] && this["on" + e](t), K(this, t)
    }, _n.prototype.dispatchEvent = _n.prototype.trigger;
    var bn = function(t) {
            return t instanceof _n || !!t.eventBusEl_ && ["on", "one", "off", "trigger"].every(function(e) {
        ...
        Cn = function(t) {
            if (!t.nodeName && !bn(t)) throw new Error("Invalid target; must be a DOM node or evented object.")
        },
        kn = function(t) {
            if (!Tn(t)) throw new Error("Invalid event type; must be a non-empty string or array.")
        },
        wn = function(t) {
        ...
        En = function(t, e) {
            var n = e.length < 3 || e[0] === t || e[0] === t.eventBusEl_,
                ...
                i = void 0,
                o = void 0;
            return n ? (r = t.eventBusEl_, e.length >= 3 && e.shift(), i = e[0], o = e[1]) : (r = e[0], i = e[1], o = e[2]), Cn(r), kn(i), wn(o), o = yn(t, o), {
                isTargetingSelf: n,
                target: r,
                type: i,
                listener: o
        ...
        Sn = function(t, e, n, r) {
            Cn(t), t.nodeName ? un[e](t, n, r) : t[e](n, r)
        },
        xn = {
            on: function() {
                ...
                if (Sn(s, "on", a, l), !o) {
                    ...
                    u.guid = l.guid, Sn(this, "on", "dispose", c), Sn(s, "on", "dispose", u)
                }
            },
            one: function() {
                for (var t = this, e = arguments.length, n = Array(e), r = 0; r < e; r++) n[r] = arguments[r];
                ...
                if (o) Sn(s, "one", a, l);
                    ...
                    c.guid = l.guid, Sn(s, "one", a, c)
                }
            },
            off: function(t, e, n) {
                if (!t || Tn(t)) q(this.eventBusEl_, t, e);
                else {
                    var r = t,
                        i = e;
                    Cn(r), kn(i), wn(n), n = yn(this, n), this.off("dispose", n), r.nodeName ? (q(r, i, n), q(r, "dispose", n)) : bn(r) && (r.off(i, n), r.off("dispose", n))
                }
            },
        ...
        An = function() {
            function t(e, n, r) {
                if (ze(this, t), !e && this.play ? this.player_ = e = this : this.player_ = e, this.options_ = tt({}, this.options_), n = this.options_ = tt(this.options_, n), this.id_ = n.id || n.el && n.el.id, !this.id_) {
            ...
            return t.prototype.dispose = function() {
                ...
                return Qe.warn("this.options() has been deprecated and will be moved to the constructor in 6.0"), t ? (this.options_ = tt(this.options_, t), this.options_) : this.options_
                ...
                return en(t, e || this.contentEl())
            }, t.prototype.$$ = function(t, e) {
                return nn(t, e || this.contentEl())
                ...
                if ("function" == typeof pe.getComputedStyle) {
                    var n = pe.getComputedStyle(this.el_);
                ...
                if (this.player() && this.player().reportUserActivity) {
                    var t = yn(this.player(), this.player().reportUserActivity),
                        e = void 0;
                ...
                if (this.supportsRaf_) {
                    t = yn(this, t);
                    var n = pe.requestAnimationFrame(t),
                        r = function() {
    ...
    An.prototype.supportsRaf_ = "function" == typeof pe.requestAnimationFrame && "function" == typeof pe.cancelAnimationFrame, An.registerComponent("Component", An);
    for (var Pn = {}, On = [
        ...
        ], Mn = On[0], Nn = void 0, In = 0; In < On.length; In++)
        if (On[In][1] in ge) {
            Nn = On[In];
            break
        }
    if (Nn)
        for (var Dn = 0; Dn < Nn.length; Dn++) Pn[Mn[Dn]] = Nn[Dn];
    ...
    for (var Ln = 0; Ln < st.errorTypes.length; Ln++) st[st.errorTypes[Ln]] = Ln, st.prototype[st.errorTypes[Ln]] = Ln;
    var Rn = at,
        Bn = function(t) {
        ...
        Wn = function(t) {
            ...
            return We(e, t), e.prototype.createEl = function() {
                ...
                return zn + " vjs-hidden " + t.prototype.buildCSSClass.call(this)
                ...
                var t = ge.activeElement,
                    e = this.player_.el_;
                this.previouslyActiveEl_ = null, (e.contains(t) || e === t) && (this.previouslyActiveEl_ = t, this.focus(), this.on(ge, "keydown", this.handleKeyDown))
            }, e.prototype.conditionalBlur_ = function() {
                this.previouslyActiveEl_ && (this.previouslyActiveEl_.focus(), this.previouslyActiveEl_ = null), this.off(ge, "keydown", this.handleKeyDown)
                ...
                if (9 === t.which) {
                    ...
                    ge.activeElement === this.el_ && (r = 0), t.shiftKey && 0 === r ? (e[e.length - 1].focus(), t.preventDefault()) : t.shiftKey || r !== e.length - 1 || (e[0].focus(), t.preventDefault())
                }
            }, e.prototype.focusableEls_ = function() {
                var t = this.el_.querySelectorAll("*");
                return Array.prototype.filter.call(t, function(t) {
                    return (t instanceof pe.HTMLAnchorElement || t instanceof pe.HTMLAreaElement) && t.hasAttribute("href") || (t instanceof pe.HTMLInputElement || t instanceof pe.HTMLSelectElement || t instanceof pe.HTMLTextAreaElement || t instanceof pe.HTMLButtonElement) && !t.hasAttribute("disabled") || t instanceof pe.HTMLIFrameElement || t instanceof pe.HTMLObjectElement || t instanceof pe.HTMLEmbedElement || t.hasAttribute("tabindex") && -1 !== t.getAttribute("tabindex") || t.hasAttribute("contenteditable")
                })
            }, e
        }(An);
    Wn.prototype.options_ = {
        pauseOnOpen: !0,
        temporary: !0
    }, An.registerComponent("ModalDialog", Wn);
    var Un = function(t) {
        function e() {
            var n, r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
                i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
            ze(this, e);
            var o = Ue(this, t.call(this));
            if (!i && (i = o, Ie)) {
                i = ge.createElement("custom");
        ...
        return We(e, t), e.prototype.addTrack = function(t) {
    ...
    for (var Xn in Un.prototype.allowedEvents_) Un.prototype["on" + Xn] = null;
    var qn = function(t, e) {
        ...
        Kn = function(t) {
            function e() {
                ...
                if (Ie) {
                    o = ge.createElement("custom");
                    for (var a in Un.prototype) "constructor" !== a && (o[a] = Un.prototype[a]);
                    for (var l in e.prototype) "constructor" !== l && (o[l] = e.prototype[l])
                }
                return o = n = Ue(this, t.call(this, i, o)), o.changing_ = !1, r = o, Ue(n, r)
            }
            return We(e, t), e.prototype.addTrack = function(e) {
                var n = this;
                e.enabled && qn(this, e), t.prototype.addTrack.call(this, e), e.addEventListener && e.addEventListener("enabledchange", function() {
                    n.changing_ || (n.changing_ = !0, qn(n, e), n.changing_ = !1, n.trigger("change"))
                })
            }, e
        }(Un),
        Yn = function(t, e) {
        ...
        Gn = function(t) {
            function e() {
                ...
                return o = n = Ue(this, t.call(this, i, o)), o.changing_ = !1, Object.defineProperty(o, "selectedIndex", {
                    get: function() {
            ...
            return We(e, t), e.prototype.addTrack = function(e) {
                var n = this;
                e.selected && Yn(this, e), t.prototype.addTrack.call(this, e), e.addEventListener && e.addEventListener("selectedchange", function() {
                    n.changing_ || (n.changing_ = !0, Yn(n, e), n.changing_ = !1, n.trigger("change"))
                })
            }, e
        }(Un),
        $n = function(t) {
            function e() {
                ...
                return o = n = Ue(this, t.call(this, i, o)), r = o, Ue(n, r)
            }
            return We(e, t), e.prototype.addTrack = function(e) {
                t.prototype.addTrack.call(this, e), e.addEventListener("modechange", yn(this, function() {
                    this.trigger("change")
                })), -1 === ["metadata", "chapters"].indexOf(e.kind) && e.addEventListener("modechange", yn(this, function() {
        ...
        ir = function(t) {
            ...
            var r = "" === n.host && "file:" !== n.protocol,
                i = void 0;
            r && (i = ge.createElement("div"), i.innerHTML = '<a href="' + t + '"></a>', n = i.firstChild, i.setAttribute("style", "display:none; position:absolute;"), ge.body.appendChild(i));
            for (var o = {}, s = 0; s < e.length; s++) o[e[s]] = n[e[s]];
            return "http:" === o.protocol && (o.host = o.host.replace(/:80$/, "")), "https:" === o.protocol && (o.host = o.host.replace(/:443$/, "")), o.protocol || (o.protocol = pe.location.protocol), r && ge.body.removeChild(i), o
        },
        or = function(t) {
            if (!t.match(/^https?:\/\//)) {
        ...
        yr = function(t) {
            if (!t) return {};
            var e = {};
            return pr(hr(t).split("\n"), function(t) {
                var n = t.indexOf(":"),
                    r = hr(t.slice(0, n)).toLowerCase(),
                    i = hr(t.slice(n + 1));
                void 0 === e[r] ? e[r] = i : vr(e[r]) ? e[r].push(i) : e[r] = [e[r], i]
            }), e
        },
        gr = vt,
        mr = Object.prototype.hasOwnProperty,
        _r = mt;
    mt.XMLHttpRequest = pe.XMLHttpRequest || Tt, mt.XDomainRequest = "withCredentials" in new mt.XMLHttpRequest ? mt.XMLHttpRequest : pe.XDomainRequest,
        function(t, e) {
    ...
    var br = function(t, e) {
            var n = new pe.WebVTT.Parser(pe, pe.vttjs, pe.WebVTT.StringDecoder()),
                r = [];
            n.oncue = function(t) {
                e.addCue(t)
            ...
            }, n.parse(t), r.length > 0 && (pe.console && pe.console.groupCollapsed && pe.console.groupCollapsed("Text Track parsing errors for " + e.src), r.forEach(function(t) {
                return Qe.error(t)
            }), pe.console && pe.console.groupEnd && pe.console.groupEnd()), n.flush()
        },
        Tr = function(t, e) {
            var n = {
                    uri: t
                ...
                r = ar(t);
            r && (n.cors = r), _r(n, yn(this, function(t, n, r) {
                if (t) return Qe.error(t, n);
                if (e.loaded_ = !0, "function" != typeof pe.WebVTT) {
                    if (e.tech_) {
                        var i = function() {
                            return br(r, e)
                        };
                        e.tech_.on("vttjsloaded", i), e.tech_.on("vttjserror", function() {
                            Qe.error("vttjs failed to load, stopping trying to process " + e.src), e.tech_.off("vttjsloaded", i)
                        })
                    }
                } else br(r, e)
            }))
        ...
        Cr = function(t) {
            function e() {
                var n, r, i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                if (ze(this, e), !i.tech) throw new Error("A tech was not provided.");
                var o = tt(i, {
                        kind: er[i.kind] || "subtitles",
                        language: i.language || i.srclang || ""
                    }),
                    s = nr[o.mode] || "disabled",
                    a = o.default;
                "metadata" !== o.kind && "chapters" !== o.kind || (s = "hidden");
                var l = n = Ue(this, t.call(this, o));
                if (l.tech_ = o.tech, Ie)
                    for (var c in e.prototype) "constructor" !== c && (l[c] = e.prototype[c]);
                l.cues_ = [], l.activeCues_ = [];
                var u = new Qn(l.cues_),
                    h = new Qn(l.activeCues_),
                    p = !1,
                    d = yn(l, function() {
                ...
                return "disabled" !== s && l.tech_.ready(function() {
                    ...
                    set: function(t) {
                        var e = this;
                        nr[t] && (s = t, "showing" === s && this.tech_.ready(function() {
                    ...
                    set: function() {}
                }), o.src ? (l.src = o.src, Tr(o.src, l)) : l.loaded_ = !0, r = l, Ue(n, r)
            }
            return We(e, t), e.prototype.addCue = function(t) {
                var e = t;
                if (pe.vttjs && !(t instanceof pe.vttjs.VTTCue)) {
                    e = new pe.vttjs.VTTCue(t.startTime, t.endTime, t.text);
    ...
    var kr = function(t) {
            function e() {
                ...
                }), o.enabled && (s.enabled = o.enabled), s.loaded_ = !0, r = s, Ue(n, r)
            }
            return We(e, t), e
        }(rr),
        wr = function(t) {
            function e() {
                ...
                }), o.selected && (s.selected = o.selected), r = s, Ue(n, r)
            }
            return We(e, t), e
        }(rr),
        Er = 0,
        ...
        xr = function(t) {
            function e() {
                ...
                if (o.kind = a.kind, o.src = a.src, o.srclang = a.language, o.label = a.label, o.default = a.default, Object.defineProperty(o, "readyState", {
                    ...
                    }), i = Er, a.addEventListener("loadeddata", function() {
                        i = Sr, o.trigger({
                            type: "load",
                            target: o
                        })
    ...
    xr.prototype.allowedEvents_ = {
        load: "load"
    }, xr.NONE = Er, xr.LOADING = 1, xr.LOADED = Sr, xr.ERROR = 3;
    var jr = {
        audio: {
            ListClass: Kn,
            TrackClass: kr,
    ...
    Object.keys(jr).forEach(function(t) {
        jr[t].getterName = t + "Tracks", jr[t].privateName = t + "Tracks_"
    });
    var Ar = {
            remoteText: {
                ListClass: $n,
        ...
        Pr = tt(jr, Ar);
    Ar.names = Object.keys(Ar), jr.names = Object.keys(jr), Pr.names = [].concat(Ar.names).concat(jr.names);
    var Or = Object.create || function() {
        function t() {}
        return function(e) {
    ...
    Ct.prototype = Or(Error.prototype), Ct.prototype.constructor = Ct, Ct.Errors = {
        BadSignature: {
            code: 0,
    ...
    Ot.prototype.applyStyles = function(t, e) {
        ...
        return 0 === t ? 0 : t + e
    }, Mt.prototype = Or(Ot.prototype), Mt.prototype.constructor = Mt, Nt.prototype.move = function(t, e) {
    ...
    Dt.processCues = function(t, e, n) {
        ...
        if (r.style.position = "absolute", r.style.left = "0", r.style.right = "0", r.style.top = "0", r.style.bottom = "0", r.style.margin = "1.5%", n.appendChild(r), function(t) {
            ...
            ! function() {
                for (var n, s, l = 0; l < e.length; l++) s = e[l], n = new Mt(t, s, a), r.appendChild(n.div), It(t, n, o, i), s.displayState = n.div, i.push(Nt.getSimpleBoxPosition(n))
            }()
        } else
            ...
            try {
                ...
                for (var a = !1; i.buffer;) {
                    ...
                    switch (a ? a = !1 : o = e(), i.state) {
                        case "HEADER":
                            /:/.test(o) ? function(t) {
                                t.match(/X-TIMESTAMP-MAP/) ? Et(t, function(t, e) {
                                    switch (t) {
    ...
    var Vr = Ft,
        ...
        Ur = t(function(t) {
            ...
            pe.vttjs = e, pe.WebVTT = e.WebVTT;
            var n = e.VTTCue,
                r = e.VTTRegion,
                i = pe.VTTCue,
                o = pe.VTTRegion;
            e.shim = function() {
                pe.VTTCue = n, pe.VTTRegion = r
            }, e.restore = function() {
                pe.VTTCue = i, pe.VTTRegion = o
            }, pe.VTTCue || e.shim()
        }),
        Xr = function(t) {
            function e() {
                ...
                ze(this, e), n.reportTouchActivity = !1;
                var i = Ue(this, t.call(this, null, n, r));
                return i.hasStarted_ = !1, i.on("playing", function() {
                    this.hasStarted_ = !0
                }), i.on("loadstart", function() {
                    this.hasStarted_ = !1
                }), Pr.names.forEach(function(t) {
                    var e = Pr[t];
                ...
                }), !1 === n.nativeCaptions || !1 === n.nativeTextTracks ? i.featuresNativeTextTracks = !1 : !0 !== n.nativeCaptions && !0 !== n.nativeTextTracks || (i.featuresNativeTextTracks = !0), i.featuresNativeTextTracks || i.emulateTextTracks(), i.autoRemoteTextTracks_ = new Pr.text.ListClass, i.initTrackListeners(), n.nativeControlsForTouch || i.emitTapEvents(), i.constructor && (i.name_ = i.constructor.name || "Unknown Tech"), i
            }
            return We(e, t), e.prototype.manualProgressOn = function() {
                this.on("durationchange", this.onDurationChange), this.manualProgress = !0, this.one("ready", this.trackProgress)
            }, e.prototype.manualProgressOff = function() {
                this.manualProgress = !1, this.stopTrackingProgress(), this.off("durationchange", this.onDurationChange)
            }, e.prototype.trackProgress = function(t) {
                this.stopTrackingProgress(), this.progressInterval = this.setInterval(yn(this, function() {
                ...
                this.clearTracks(jr.names), this.manualProgress && this.manualProgressOff(), this.manualTimeUpdates && this.manualTimeUpdatesOff(), t.prototype.dispose.call(this)
                ...
                var t = this;
                if (!pe.WebVTT)
                    if (ge.body.contains(this.el())) {
                        if (!this.options_["vtt.js"] && o(Ur) && Object.keys(Ur).length > 0) return void this.trigger("vttjsloaded");
                        var e = ge.createElement("script");
                ...
                return new Ar.remoteTextEl.TrackClass(e)
            }, e.prototype.addRemoteTextTrack = function() {
                var t = this,
                    e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    n = arguments[1],
                    r = this.createRemoteTextTrack(e);
                return !0 !== n && !1 !== n && (Qe.warn('Calling addRemoteTextTrack without explicitly setting the "manualCleanup" parameter to `true` is deprecated and default to `false` in future version of video.js'), n = !0), this.remoteTextTrackEls().addTrackElement_(r), this.remoteTextTracks().addTrack(r.track), !0 !== n && this.ready(function() {
                ...
                if (t) return t = Q(t), e.techs_ && e.techs_[t] ? e.techs_[t] : pe && pe.videojs && pe.videojs[t] ? (Qe.warn("The " + t + " tech was added to the videojs object when it should be registered using videojs.registerTech(name, tech)"), pe.videojs[t]) : void 0
            }, e
        }(An);
    Pr.names.forEach(function(t) {
        var e = Pr[t];
        Xr.prototype[e.getterName] = function() {
            return this[e.privateName] = this[e.privateName] || new e.ListClass, this[e.privateName]
        }
    }), Xr.prototype.featuresVolumeControl = !0, Xr.prototype.featuresFullscreenResize = !1, Xr.prototype.featuresPlaybackRate = !1, Xr.prototype.featuresProgressEvents = !1, Xr.prototype.featuresTimeupdateEvents = !1, Xr.prototype.featuresNativeTextTracks = !1, Xr.withSourceHandlers = function(t) {
    ...
    }, An.registerComponent("Tech", Xr), Xr.registerTech("Tech", Xr), Xr.defaultTechOrder_ = [];
    var qr = {},
        Kr = {},
        Yr = {},
        Gr = {
            ...
            function e(n, r, i) {
                ...
                if (r.playerOptions.sources && 0 !== r.playerOptions.sources.length) n.src(r.playerOptions.sources);
                    ...
                    for (var a = 0, l = r.playerOptions.techOrder; a < l.length; a++) {
                        var c = Q(l[a]),
                            u = Xr.getTech(c);
                        if (c || (u = An.getComponent(c)), u && u.isSupported()) {
                            n.loadTech_(c);
                            break
                        }
                    }
    ...
    An.registerComponent("MediaLoader", Zr);
    var ti = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
        ...
        return We(e, t), e.prototype.createEl = function() {
            ...
            n = r({
                ...
                className: this.buildCSSClass(),
                tabIndex: 0
            }, n), "button" === e && Qe.error("Creating a ClickableComponent with an HTML element of " + e + " is not supported; use a Button instead."), i = r({
                role: "button",
                "aria-live": "polite"
            ...
            X(ge, "keydown", yn(this, this.handleKeyPress))
            ...
            q(ge, "keydown", yn(this, this.handleKeyPress))
        }, e
    }(An);
    An.registerComponent("ClickableComponent", ti);
    var ei = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
            return i.update(), n.on("posterchange", yn(i, i.update)), i
        }
        return We(e, t), e.prototype.dispose = function() {
            ...
            return Fe || (this.fallbackImg_ = v("img"), t.appendChild(this.fallbackImg_)), t
    ...
    An.registerComponent("PosterImage", ei);
    var ni = {
            monospace: "monospace",
        ...
        ri = function(t) {
            function e(n, r, i) {
                ze(this, e);
                var o = Ue(this, t.call(this, n, r, i));
                return n.on("loadstart", yn(o, o.toggleDisplay)), n.on("texttrackchange", yn(o, o.updateDisplay)), n.on("loadstart", yn(o, o.preselectTrack)), n.ready(yn(o, function() {
            ...
            return We(e, t), e.prototype.preselectTrack = function() {
                for (var t = {
                        captions: 1,
                        subtitles: 1
                ...
                "function" == typeof pe.WebVTT && pe.WebVTT.processCues(pe, [], this.el_)
                ...
                if ("function" == typeof pe.WebVTT && t.activeCues) {
    ...
    An.registerComponent("LoadingSpinner", ii);
    var oi = function(t) {
        function e() {
            return ze(this, e), Ue(this, t.apply(this, arguments))
        }
        return We(e, t), e.prototype.createEl = function(t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
            t = "button", e = r({
                innerHTML: '<span aria-hidden="true" class="vjs-icon-placeholder"></span>',
            ...
            var i = An.prototype.createEl.call(this, t, e, n);
            return this.createControlTextEl(i), i
        }, e.prototype.addChild = function(t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                n = this.constructor.name;
            return Qe.warn("Adding an actionable (user controllable) child to a Button (" + n + ") is not supported; use a ClickableComponent instead."), An.prototype.addChild.call(this, t, e)
        }, e.prototype.enable = function() {
    ...
    An.registerComponent("Button", oi);
    var si = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
        ...
        return We(e, t), e.prototype.buildCSSClass = function() {
    ...
    si.prototype.controlText_ = "Play Video", An.registerComponent("BigPlayButton", si);
    var ai = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
    ...
    An.registerComponent("CloseButton", ai);
    var li = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
    ...
    li.prototype.controlText_ = "Play", An.registerComponent("PlayToggle", li);
    var ci = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
            return i.throttledUpdateContent = gn(yn(i, i.updateContent), 25), i.on(n, "timeupdate", i.throttledUpdateContent), i
        }
        return We(e, t), e.prototype.createEl = function(e) {
            ...
            if (this.contentEl_) {
                ...
                this.textNode_ = ge.createTextNode(this.formattedTime_ || "0:00"), this.contentEl_.appendChild(this.textNode_)
            }
    ...
    ci.prototype.controlText_ = "Time", An.registerComponent("TimeDisplay", ci);
    var ui = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
    ...
    ui.prototype.controlText_ = "Current Time", An.registerComponent("CurrentTimeDisplay", ui);
    var hi = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
    ...
    hi.prototype.controlText_ = "Duration Time", An.registerComponent("DurationDisplay", hi);
    var pi = function(t) {
        function e() {
            return ze(this, e), Ue(this, t.apply(this, arguments))
        }
    ...
    An.registerComponent("TimeDivider", pi);
    var di = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
    ...
    di.prototype.controlText_ = "Remaining Time", An.registerComponent("RemainingTimeDisplay", di);
    var fi = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
    ...
    An.registerComponent("LiveDisplay", fi);
    var vi = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
        ...
        return We(e, t), e.prototype.enabled = function() {
    ...
    An.registerComponent("Slider", vi);
    var yi = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
    ...
    An.registerComponent("LoadProgressBar", yi);
    var gi = function(t) {
        function e() {
            return ze(this, e), Ue(this, t.apply(this, arguments))
        }
    ...
    An.registerComponent("TimeTooltip", gi);
    var mi = function(t) {
        function e() {
            return ze(this, e), Ue(this, t.apply(this, arguments))
        }
    ...
    mi.prototype.options_ = {
        children: []
    }, De && !(De > 8) || we || Se || mi.prototype.options_.children.push("timeTooltip"), An.registerComponent("PlayProgressBar", mi);
    var _i = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
            return i.update = gn(yn(i, i.update), 25), i
        }
        return We(e, t), e.prototype.createEl = function() {
            return t.prototype.createEl.call(this, "div", {
    ...
    }, An.registerComponent("MouseTimeDisplay", _i);
    var bi = 30,
        Ti = function(t) {
            function e(n, r) {
                ze(this, e);
                var i = Ue(this, t.call(this, n, r));
                return i.update = gn(yn(i, i.update), bi), i.on(n, "timeupdate", i.update), i.on(n, "ended", i.handleEnded), i.updateInterval = null, i.on(n, ["playing"], function() {
            ...
            return We(e, t), e.prototype.createEl = function() {
                ...
                this.el_.setAttribute("aria-valuenow", (100 * e).toFixed(2)), this.el_.setAttribute("aria-valuetext", this.localize("progress bar timing: currentTime={1} duration={2}", [re(t, n), re(n, n)], "{1} of {2}")), this.bar.update(A(this.el_), e)
                ...
                R(e) && (e.stopPropagation(), this.player_.scrubbing(!0), this.videoWasPlaying = !this.player_.paused(), this.player_.pause(), t.prototype.handleMouseDown.call(this, e))
                ...
                t.prototype.handleMouseUp.call(this, e), e.stopPropagation(), this.player_.scrubbing(!1), this.player_.trigger({
                    type: "timeupdate",
                    target: this,
                    manuallyTriggered: !0
    ...
    }, De && !(De > 8) || we || Se || Ti.prototype.options_.children.splice(1, 0, "mouseTimeDisplay"), Ti.prototype.playerEvent = "timeupdate", An.registerComponent("SeekBar", Ti);
    var Ci = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
            return i.handleMouseMove = gn(yn(i, i.handleMouseMove), 25), i.throttledHandleMouseSeek = gn(yn(i, i.handleMouseSeek), 25), i.enable(), i
        }
        return We(e, t), e.prototype.createEl = function() {
            return t.prototype.createEl.call(this, "div", {
            ...
            if (e) {
                var n = e.getChild("mouseTimeDisplay"),
                    r = e.el(),
                    i = A(r),
                    o = O(r, t).x;
    ...
    Ci.prototype.options_ = {
        children: ["seekBar"]
    }, An.registerComponent("ProgressControl", Ci);
    var ki = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
    ...
    ki.prototype.controlText_ = "Fullscreen", An.registerComponent("FullscreenToggle", ki);
    var wi = function(t, e) {
    ...
    An.registerComponent("VolumeLevel", Ei);
    var Si = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
    ...
    Si.prototype.options_ = {
        ...
        barName: "volumeLevel"
    }, Si.prototype.playerEvent = "volumechange", An.registerComponent("VolumeBar", Si);
    var xi = function(t) {
        function e(n) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            ze(this, e), r.vertical = r.vertical || !1, (void 0 === r.volumeBar || o(r.volumeBar)) && (r.volumeBar = r.volumeBar || {}, r.volumeBar.vertical = r.vertical);
            var i = Ue(this, t.call(this, n, r));
            return wi(i, n), i.throttledHandleMouseMove = gn(yn(i, i.handleMouseMove), 25), i.on("mousedown", i.handleMouseDown), i.on("touchstart", i.handleMouseDown), i.on(i.volumeBar, ["focus", "slideractive"], function() {
    ...
    xi.prototype.options_ = {
        children: ["volumeBar"]
    }, An.registerComponent("VolumeControl", xi);
    var ji = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
            return wi(i, n), i.on(n, ["loadstart", "volumechange"], i.update), i
        }
        return We(e, t), e.prototype.buildCSSClass = function() {
    ...
    ji.prototype.controlText_ = "Mute", An.registerComponent("MuteToggle", ji);
    var Ai = function(t) {
        function e(n) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            ze(this, e), void 0 !== r.inline ? r.inline = r.inline : r.inline = !0, (void 0 === r.volumeControl || o(r.volumeControl)) && (r.volumeControl = r.volumeControl || {}, r.volumeControl.vertical = !r.inline);
            var i = Ue(this, t.call(this, n, r));
            return wi(i, n), i.on(i.volumeControl, ["slideractive"], i.sliderActive_), i.on(i.volumeControl, ["sliderinactive"], i.sliderInactive_), i
        }
        return We(e, t), e.prototype.sliderActive_ = function() {
    ...
    }, An.registerComponent("VolumePanel", Ai);
    var Pi = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
        ...
        return We(e, t), e.prototype.addItem = function(t) {
            this.addChild(t), t.on("click", yn(this, function(e) {
    ...
    An.registerComponent("Menu", Pi);
    var Oi = function(t) {
        function e(n) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
            i.menuButton_ = new oi(n, r), i.menuButton_.controlText(i.controlText_), i.menuButton_.el_.setAttribute("aria-haspopup", "true");
            var o = oi.prototype.buildCSSClass();
        ...
        return We(e, t), e.prototype.update = function() {
            ...
            return !0 === this.options_.inline ? e += "-inline" : e += "-popup", "vjs-menu-button " + e + " " + oi.prototype.buildCSSClass() + " " + t.prototype.buildCSSClass.call(this)
        }, e.prototype.buildCSSClass = function() {
            var e = "vjs-menu-button";
            ...
            this.one(this.menu.contentEl(), "mouseleave", yn(this, function(t) {
            ...
            if (this.enabled_) {
                if (this.buttonPressed_ = !0, this.menu.lockShowing(), this.menuButton_.el_.setAttribute("aria-expanded", "true"), we && d()) return;
                this.menu.focus()
            }
    ...
    An.registerComponent("MenuButton", Oi);
    var Mi = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = r.tracks,
                o = Ue(this, t.call(this, n, r));
            if (o.items.length <= 1 && o.hide(), !i) return Ue(o);
            var s = yn(o, o.update);
    ...
    An.registerComponent("TrackButton", Mi);
    var Ni = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
            return i.selectable = r.selectable, i.isSelected_ = r.selected || !1, i.selected(i.isSelected_), i.selectable ? i.el_.setAttribute("role", "menuitemcheckbox") : i.el_.setAttribute("role", "menuitem"), i
        }
        return We(e, t), e.prototype.createEl = function(e, n, i) {
    ...
    An.registerComponent("MenuItem", Ni);
    var Ii = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = r.track,
            ...
            if (n.on(["loadstart", "texttrackchange"], a), o.addEventListener("change", a), o.addEventListener("selectedlanguagechange", l), s.on("dispose", function() {
                ...
                s.on(["tap", "click"], function() {
                    if ("object" !== Ve(pe.Event)) try {
                        c = new pe.Event("change")
                    } catch (t) {}
                    c || (c = ge.createEvent("Event"), c.initEvent("change", !0, !0)), o.dispatchEvent(c)
                })
            }
            return s.handleTracksChange(), s
        }
        return We(e, t), e.prototype.handleClick = function(e) {
    ...
    An.registerComponent("TextTrackMenuItem", Ii);
    var Di = function(t) {
        function e(n, r) {
            return ze(this, e), r.track = {
                player: n,
                kind: r.kind,
                kinds: r.kinds,
                default: !1,
                mode: "disabled"
            }, r.kinds || (r.kinds = [r.kind]), r.label ? r.track.label = r.label : r.track.label = r.kinds.join(" and ") + " off", r.selectable = !0, Ue(this, t.call(this, n, r))
        }
        return We(e, t), e.prototype.handleTracksChange = function(t) {
    ...
    An.registerComponent("OffTextTrackMenuItem", Di);
    var Li = function(t) {
        function e(n) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            return ze(this, e), r.tracks = n.textTracks(), Ue(this, t.call(this, n, r))
        }
        return We(e, t), e.prototype.createItems = function() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
                e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Ii,
                n = void 0;
            this.label_ && (n = this.label_ + " off"), t.push(new Di(this.player_, {
                kinds: this.kinds_,
                kind: this.kind_,
                label: n
    ...
    An.registerComponent("TextTrackButton", Li);
    var Ri = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = r.track,
            ...
            var a = Ue(this, t.call(this, n, r));
            return a.track = i, a.cue = o, i.addEventListener("cuechange", yn(a, a.update)), a
        }
        return We(e, t), e.prototype.handleClick = function(e) {
    ...
    An.registerComponent("ChaptersTrackMenuItem", Ri);
    var Bi = function(t) {
        function e(n, r, i) {
            return ze(this, e), Ue(this, t.call(this, n, r, i))
        }
        return We(e, t), e.prototype.buildCSSClass = function() {
    ...
    Bi.prototype.kind_ = "chapters", Bi.prototype.controlText_ = "Chapters", An.registerComponent("ChaptersButton", Bi);
    var Fi = function(t) {
        function e(n, r, i) {
            ze(this, e);
            var o = Ue(this, t.call(this, n, r, i)),
    ...
    Fi.prototype.kind_ = "descriptions", Fi.prototype.controlText_ = "Descriptions", An.registerComponent("DescriptionsButton", Fi);
    var Hi = function(t) {
        function e(n, r, i) {
            return ze(this, e), Ue(this, t.call(this, n, r, i))
        }
    ...
    Hi.prototype.kind_ = "subtitles", Hi.prototype.controlText_ = "Subtitles", An.registerComponent("SubtitlesButton", Hi);
    var Vi = function(t) {
        function e(n, r) {
            ze(this, e), r.track = {
                player: n,
        ...
        return We(e, t), e.prototype.handleClick = function(t) {
            this.player().getChild("textTrackSettings").open()
        }, e
    }(Ii);
    An.registerComponent("CaptionSettingsMenuItem", Vi);
    var zi = function(t) {
        function e(n, r, i) {
            return ze(this, e), Ue(this, t.call(this, n, r, i))
        }
        return We(e, t), e.prototype.buildCSSClass = function() {
            ...
            var e = [];
            return this.player().tech_ && this.player().tech_.featuresNativeTextTracks || (e.push(new Vi(this.player_, {
                kind: this.kind_
            })), this.hideThreshold_ += 1), t.prototype.createItems.call(this, e)
        }, e
    }(Li);
    zi.prototype.kind_ = "captions", zi.prototype.controlText_ = "Captions", An.registerComponent("CaptionsButton", zi);
    var Wi = function(t) {
        function e() {
            return ze(this, e), Ue(this, t.apply(this, arguments))
        }
    ...
    An.registerComponent("SubsCapsMenuItem", Wi);
    var Ui = function(t) {
        function e(n) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            ze(this, e);
        ...
        return We(e, t), e.prototype.buildCSSClass = function() {
            ...
            return this.player().tech_ && this.player().tech_.featuresNativeTextTracks || (e.push(new Vi(this.player_, {
                kind: this.label_
            })), this.hideThreshold_ += 1), e = t.prototype.createItems.call(this, e, Wi)
        }, e
    }(Li);
    Ui.prototype.kinds_ = ["captions", "subtitles"], Ui.prototype.controlText_ = "Subtitles", An.registerComponent("SubsCapsButton", Ui);
    var Xi = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = r.track,
    ...
    An.registerComponent("AudioTrackMenuItem", Xi);
    var qi = function(t) {
        function e(n) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            return ze(this, e), r.tracks = n.audioTracks(), Ue(this, t.call(this, n, r))
        }
        return We(e, t), e.prototype.buildCSSClass = function() {
    ...
    qi.prototype.controlText_ = "Audio Track", An.registerComponent("AudioTrackButton", qi);
    var Ki = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = r.rate,
    ...
    Ki.prototype.contentElType = "button", An.registerComponent("PlaybackRateMenuItem", Ki);
    var Yi = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
        ...
        return We(e, t), e.prototype.createEl = function() {
            ...
            if (e)
                for (var n = e.length - 1; n >= 0; n--) t.addChild(new Ki(this.player(), {
                    rate: e[n] + "x"
                }));
            return t
    ...
    Yi.prototype.controlText_ = "Playback Rate", An.registerComponent("PlaybackRateMenuButton", Yi);
    var Gi = function(t) {
        function e() {
            return ze(this, e), Ue(this, t.apply(this, arguments))
        }
    ...
    An.registerComponent("Spacer", Gi);
    var $i = function(t) {
        function e() {
            return ze(this, e), Ue(this, t.apply(this, arguments))
        }
    ...
    An.registerComponent("CustomControlSpacer", $i);
    var Ji = function(t) {
        function e() {
            return ze(this, e), Ue(this, t.apply(this, arguments))
        }
    ...
    }, An.registerComponent("ControlBar", Ji);
    var Qi = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = Ue(this, t.call(this, n, r));
    ...
    Qi.prototype.options_ = tt(Wn.prototype.options_, {
        pauseOnOpen: !1,
        fillAlways: !0,
        temporary: !1,
        uncloseable: !0
    }), An.registerComponent("ErrorDisplay", Qi);
    var Zi = ["#000", "Black"],
        to = ["#00F", "Blue"],
        eo = ["#0FF", "Cyan"],
        no = ["#0F0", "Green"],
        ...
        uo = {
            backgroundColor: {
                ...
                label: "Color",
                options: [Zi, oo, io, no, to, so, ro, eo]
            },
            backgroundOpacity: {
            ...
            color: {
                ...
                label: "Color",
                options: [oo, Zi, io, no, to, so, ro, eo]
            },
            edgeStyle: {
    ...
    var ho = function(t) {
        function r(n, i) {
            ze(this, r), i.temporary = !1;
            var o = Ue(this, t.call(this, n, i));
            return o.updateDisplay = yn(o, o.updateDisplay), o.fill(), o.hasBeenOpened_ = o.hasBeenFilled_ = !0, o.endDialog = v("p", {
                className: "vjs-control-text",
        ...
        return We(r, t), r.prototype.dispose = function() {
            ...
            var t = this;
            return n(uo, function(e, n, r) {
                var i = oe(t.$(n.selector), n.parser);
                return void 0 !== i && (e[r] = i), e
            }, {})
        }, r.prototype.setValues = function(t) {
            var n = this;
            e(uo, function(e, r) {
                se(n.$(e.selector), t[r], e.parser)
            })
            ...
            var t = void 0;
            try {
                t = JSON.parse(pe.localStorage.getItem("vjs-text-track-settings"))
            } catch (t) {
                Qe.warn(t)
            }
            t && this.setValues(t)
            ...
            if (this.options_.persistTextTrackSettings) {
                ...
                try {
                    Object.keys(t).length ? pe.localStorage.setItem("vjs-text-track-settings", JSON.stringify(t)) : pe.localStorage.removeItem("vjs-text-track-settings")
                } catch (t) {
                    Qe.warn(t)
                }
            }
            ...
            this.previouslyActiveEl_ = null, this.off(ge, "keydown", this.handleKeyDown);
    ...
    An.registerComponent("TextTrackSettings", ho);
    var po = function(t) {
        function e(n, r) {
            ze(this, e);
            var i = r.ResizeObserver || pe.ResizeObserver;
            null === r.ResizeObserver && (i = !1);
            var o = tt({
                    createEl: !i
                }, r),
                s = Ue(this, t.call(this, n, o));
            return s.ResizeObserver = r.ResizeObserver || pe.ResizeObserver, s.loadListener_ = null, s.resizeObserver_ = null, s.debouncedHandler_ = mn(function() {
                s.resizeHandler()
            }, 100, !1, n), i ? (s.resizeObserver_ = new s.ResizeObserver(s.debouncedHandler_), s.resizeObserver_.observe(n.el())) : (s.loadListener_ = function() {
                s.el_.contentWindow && X(s.el_.contentWindow, "resize", s.debouncedHandler_), s.off("load", s.loadListener_)
        ...
        return We(e, t), e.prototype.createEl = function() {
            ...
            this.resizeObserver_ && (this.resizeObserver_.unobserve(this.player_.el()), this.resizeObserver_.disconnect()), this.el_ && this.el_.contentWindow && q(this.el_.contentWindow, "resize", this.debouncedHandler_), this.loadListener_ && this.off("load", this.loadListener_), this.ResizeObserver = null, this.resizeObserver = null, this.debouncedHandler_ = null, this.loadListener_ = null
        }, e
    }(An);
    An.registerComponent("ResizeManager", po);
    var fo = Xe(["Text Tracks are being loaded from another origin but the crossorigin attribute isn't used.\n            This may prevent text tracks from loading."], ["Text Tracks are being loaded from another origin but the crossorigin attribute isn't used.\n            This may prevent text tracks from loading."]),
        vo = function(t) {
            function e(n, r) {
                ze(this, e);
                var i = Ue(this, t.call(this, n, r)),
                ...
                if (o && (i.el_.currentSrc !== o.src || n.tag && 3 === n.tag.initNetworkState_) ? i.setSource(o) : i.handleLateInit_(i.el_), i.el_.hasChildNodes()) {
                    for (var a = i.el_.childNodes, l = a.length, c = []; l--;) {
                        var u = a[l];
                        "track" === u.nodeName.toLowerCase() && (i.featuresNativeTextTracks ? (i.remoteTextTrackEls().addTrackElement_(u), i.remoteTextTracks().addTrack(u.track), i.textTracks().addTrack(u.track), s || i.el_.hasAttribute("crossorigin") || !ar(u.src) || (s = !0)) : c.push(u))
                    }
                    for (var h = 0; h < c.length; h++) i.el_.removeChild(c[h])
                }
                return i.proxyNativeTracks_(), i.featuresNativeTextTracks && s && Qe.warn(Ze(fo)), i.restoreMetadataTracksInIOSNativePlayer_(), (Be || Ce || Ae) && !0 === n.nativeControlsForTouch && i.setControls(!0), i.proxyWebkitFullscreen_(), i.triggerReady(), i
            }
            return We(e, t), e.prototype.dispose = function() {
                ...
                if (!t || !this.options_.playerElIngest && !this.movingMediaElementInDOM) {
                    if (t) {
                        ...
                        t = ge.createElement("video");
                        var i = this.options_.tag && k(this.options_.tag),
                            o = tt({}, i);
                        Be && !0 === this.options_.nativeControlsForTouch || delete o.controls, C(t, r(o, {
                ...
                var t = this;
                if (this.el_.duration === 1 / 0 && Se && Me && 0 === this.el_.currentTime) {
                    var e = function e() {
                ...
                if ("function" == typeof this.el_.webkitEnterFullScreen) {
                    var t = pe.navigator && pe.navigator.userAgent || "";
                ...
                var t = {};
                return void 0 !== this.el().webkitDroppedFrameCount && void 0 !== this.el().webkitDecodedFrameCount && (t.droppedVideoFrames = this.el().webkitDroppedFrameCount, t.totalVideoFrames = this.el().webkitDecodedFrameCount), pe.performance && "function" == typeof pe.performance.now ? t.creationTime = pe.performance.now() : pe.performance && pe.performance.timing && "number" == typeof pe.performance.timing.navigationStart && (t.creationTime = pe.Date.now() - pe.performance.timing.navigationStart), t
            }, e
        }(Xr);
    if (h()) {
        vo.TEST_VID = ge.createElement("video");
        var yo = ge.createElement("track");
        yo.kind = "captions", yo.srclang = "en", yo.label = "English", vo.TEST_VID.appendChild(yo)
    }
    vo.isSupported = function() {
        try {
            vo.TEST_VID.volume = .5
        } catch (t) {
            return !1
        }
        return !(!vo.TEST_VID || !vo.TEST_VID.canPlayType)
    }, vo.canPlayType = function(t) {
        return vo.TEST_VID.canPlayType(t)
    }, vo.canPlaySource = function(t, e) {
        return vo.canPlayType(t.type)
    }, vo.canControlVolume = function() {
        try {
            var t = vo.TEST_VID.volume;
            return vo.TEST_VID.volume = t / 2 + .1, t !== vo.TEST_VID.volume
        } catch (t) {
            return !1
        }
    }, vo.canControlPlaybackRate = function() {
        if (Se && Me && Ne < 58) return !1;
        try {
            var t = vo.TEST_VID.playbackRate;
            return vo.TEST_VID.playbackRate = t / 2 + .1, t !== vo.TEST_VID.playbackRate
        } catch (t) {
            return !1
        }
    }, vo.supportsNativeTextTracks = function() {
        return Re
    }, vo.supportsNativeVideoTracks = function() {
        return !(!vo.TEST_VID || !vo.TEST_VID.videoTracks)
    }, vo.supportsNativeAudioTracks = function() {
        return !(!vo.TEST_VID || !vo.TEST_VID.audioTracks)
    }, vo.Events = ["loadstart", "suspend", "abort", "error", "emptied", "stalled", "loadedmetadata", "loadeddata", "canplay", "canplaythrough", "playing", "waiting", "seeking", "seeked", "ended", "durationchange", "timeupdate", "progress", "play", "pause", "ratechange", "resize", "volumechange"], vo.prototype.featuresVolumeControl = vo.canControlVolume(), vo.prototype.featuresPlaybackRate = vo.canControlPlaybackRate(), vo.prototype.movingMediaElementInDOM = !we, vo.prototype.featuresFullscreenResize = !0, vo.prototype.featuresProgressEvents = !0, vo.prototype.featuresTimeupdateEvents = !0, vo.prototype.featuresNativeTextTracks = vo.supportsNativeTextTracks(), vo.prototype.featuresNativeVideoTracks = vo.supportsNativeVideoTracks(), vo.prototype.featuresNativeAudioTracks = vo.supportsNativeAudioTracks();
    var go = vo.TEST_VID && vo.TEST_VID.constructor.prototype.canPlayType,
        mo = /^application\/(?:x-|vnd\.apple\.)mpegurl/i,
        _o = /^video\/mp4/i;
    vo.patchCanPlayType = function() {
            xe >= 4 && !Pe && !Me ? vo.TEST_VID.constructor.prototype.canPlayType = function(t) {
                return t && mo.test(t) ? "maybe" : go.call(this, t)
            } : je && (vo.TEST_VID.constructor.prototype.canPlayType = function(t) {
                return t && _o.test(t) ? "maybe" : go.call(this, t)
            })
        }, vo.unpatchCanPlayType = function() {
            var t = vo.TEST_VID.constructor.prototype.canPlayType;
            return vo.TEST_VID.constructor.prototype.canPlayType = go, t
        }, vo.patchCanPlayType(), vo.disposeMediaElement = function(t) {
            if (t) {
        ...
        }, vo.resetMediaElement = function(t) {
            if (t) {
            ...
            vo.prototype["set" + Q(t)] = function(e) {
        ...
        }), Xr.withSourceHandlers(vo), vo.nativeSourceHandler = {}, vo.nativeSourceHandler.canPlayType = function(t) {
            try {
                return vo.TEST_VID.canPlayType(t)
            } catch (t) {
                return ""
            }
        }, vo.nativeSourceHandler.canHandleSource = function(t, e) {
            if (t.type) return vo.nativeSourceHandler.canPlayType(t.type);
            if (t.src) {
                var n = sr(t.src);
                return vo.nativeSourceHandler.canPlayType("video/" + n)
            }
            return ""
        },
        vo.nativeSourceHandler.handleSource = function(t, e, n) {
            e.setSrc(t.src)
        }, vo.nativeSourceHandler.dispose = function() {}, vo.registerSourceHandler(vo.nativeSourceHandler), Xr.registerTech("Html5", vo);
    var bo = Xe(["\n        Using the tech directly can be dangerous. I hope you know what you're doing.\n        See https://github.com/videojs/video.js/issues/2617 for more info.\n      "], ["\n        Using the tech directly can be dangerous. I hope you know what you're doing.\n        See https://github.com/videojs/video.js/issues/2617 for more info.\n      "]),
        To = ["progress", "abort", "suspend", "emptied", "stalled", "loadedmetadata", "loadeddata", "timeupdate", "ratechange", "resize", "volumechange", "texttrackchange"],
        Co = function(t) {
            function e(n, i, o) {
                if (ze(this, e), n.id = n.id || "vjs_video_" + B(), i = r(e.getTagSettings(n), i), i.initChildren = !1, i.createEl = !1, i.evented = !1, i.reportTouchActivity = !1, !i.language)
                ...
                var l = Ue(this, t.call(this, null, i, o));
                ...
                l.options_.playerOptions = u, l.middleware_ = [], l.initChildren(), l.isAudio("audio" === n.nodeName.toLowerCase()), l.controls() ? l.addClass("vjs-controls-enabled") : l.addClass("vjs-controls-disabled"), l.el_.setAttribute("role", "region"), l.isAudio() ? l.el_.setAttribute("aria-label", l.localize("Audio Player")) : l.el_.setAttribute("aria-label", l.localize("Video Player")), l.isAudio() && l.addClass("vjs-audio"), l.flexNotSupported_() && l.addClass("vjs-no-flex"), we || l.addClass("vjs-workinghover"), e.players[l.id_] = l;
                var p = ce.split(".")[0];
            ...
            return We(e, t), e.prototype.dispose = function() {
                this.trigger("dispose"), this.off("dispose"), this.styleEl_ && this.styleEl_.parentNode && (this.styleEl_.parentNode.removeChild(this.styleEl_), this.styleEl_ = null), e.players[this.id_] = null, this.tag && this.tag.player && (this.tag.player = null), this.el_ && this.el_.player && (this.el_.player = null), this.tech_ && this.tech_.dispose(), this.playerElIngest_ && (this.playerElIngest_ = null), this.tag && (this.tag = null), Qt(this), t.prototype.dispose.call(this)
            }, e.prototype.createEl = function() {
                var e = this.tag,
                    n = void 0,
                ...
                var o = k(e);
                if (i) {
                    for (n = this.el_ = e, e = this.tag = ge.createElement("video"); n.children.length;) e.appendChild(n.firstChild);
                ...
                if (e.setAttribute("tabindex", "-1"), e.removeAttribute("width"), e.removeAttribute("height"), Object.getOwnPropertyNames(o).forEach(function(t) {
                    ...
                    }), e.playerId = e.id, e.id += "_html5_api", e.className = "vjs-tech", e.player = n.player = this, this.addClass("vjs-paused"), !0 !== pe.VIDEOJS_NO_DYNAMIC_STYLE) {
                    this.styleEl_ = fn("vjs-styles-dimensions");
                    var s = en(".vjs-styles-defaults"),
                        a = en("head");
                ...
                var r = parseFloat(e);
                if (isNaN(r)) return void Qe.error('Improper value "' + e + '" supplied for for ' + t);
                ...
                if (!0 === pe.VIDEOJS_NO_DYNAMIC_STYLE) {
                ...
                var a = o.split(":"),
                    l = a[1] / a[0];
                r = void 0 !== this.width_ ? this.width_ : void 0 !== this.height_ ? this.height_ / l : this.videoWidth() || 300, i = void 0 !== this.height_ ? this.height_ : r * l, s = /^[^a-zA-Z]/.test(this.id()) ? "dimensions-" + this.id() : this.id() + "-dimensions", this.addClass(s), vn(this.styleEl_, "\n      ." + s + " {\n        width: " + r + "px;\n        height: " + i + "px;\n      }\n\n      ." + s + ".vjs-fluid {\n        padding-top: " + 100 * l + "%;\n      }\n    ")
            }, e.prototype.loadTech_ = function(t, e) {
                var n = this;
                this.tech_ && this.unloadTech_();
                var i = Q(t),
                    o = t.charAt(0).toLowerCase() + t.slice(1);
                "Html5" !== i && this.tag && (Xr.getTech("Html5").disposeMediaElement(this.tag), this.tag.player = null, this.tag = null), this.techName_ = i, this.isReady_ = !1;
                var s = {
                    source: e,
                ...
                this.tech_ = new a(s), this.tech_.ready(yn(this, this.handleTechReady_), !0), Vn.jsonToTextTracks(this.textTracksJson_ || [], this.tech_), To.forEach(function(t) {
                ...
                }), this.textTracksJson_ = Vn.textTracksToJson(this.tech_), this.isReady_ = !1, this.tech_.dispose(), this.tech_ = !1
            }, e.prototype.tech = function(t) {
                return void 0 === t && Qe.warn(Ze(bo)), this.tech_
                ...
                this.ready(function() {
                    if (t in $r) return Yt(this.middleware_, this.tech_, t, e);
                    if (t in Jr) return Gt(this.middleware_, this.tech_, t, e);
                    try {
                ...
                if (this.tech_ && this.tech_.isReady_) {
                    if (t in Gr) return Kt(this.middleware_, this.tech_, t);
                    if (t in Jr) return Gt(this.middleware_, this.tech_, t);
                    try {
                        return this.tech_[t]()
                    } catch (e) {
                        if (void 0 === this.tech_[t]) throw Qe("Video.js: " + t + " method not defined for " + this.techName_ + " playback technology.", e), e;
                        if ("TypeError" === e.name) throw Qe("Video.js: " + t + " unavailable on " + this.techName_ + " playback technology element.", e), this.tech_.isReady_ = !1, e;
                        throw Qe(e), e
                    }
                }
                ...
                var t = Pn;
                this.isFullscreen(!0), t.requestFullscreen ? (X(ge, t.fullscreenchange, yn(this, function e(n) {
                    this.isFullscreen(ge[t.fullscreenElement]), !1 === this.isFullscreen() && q(ge, t.fullscreenchange, e), this.trigger("fullscreenchange")
                ...
                var t = Pn;
                this.isFullscreen(!1), t.requestFullscreen ? ge[t.exitFullscreen]() : this.tech_.supportsFullScreen() ? this.techCall_("exitFullScreen") : (this.exitFullWindow(), this.trigger("fullscreenchange"))
            }, e.prototype.enterFullWindow = function() {
                this.isFullWindow = !0, this.docOrigOverflow = ge.documentElement.style.overflow, X(ge, "keydown", yn(this, this.fullWindowOnEscKey)), ge.documentElement.style.overflow = "hidden", _(ge.body, "vjs-full-window"), this.trigger("enterFullWindow")
            }, e.prototype.fullWindowOnEscKey = function(t) {
                27 === t.keyCode && (!0 === this.isFullscreen() ? this.exitFullscreen() : this.exitFullWindow())
            }, e.prototype.exitFullWindow = function() {
                this.isFullWindow = !1, q(ge, "keydown", this.fullWindowOnEscKey), ge.documentElement.style.overflow = this.docOrigOverflow, b(ge.body, "vjs-full-window"), this.trigger("exitFullWindow")
            }, e.prototype.canPlayType = function(t) {
                for (var e = void 0, n = 0, r = this.options_.techOrder; n < r.length; n++) {
                    var i = r[n],
                        o = Xr.getTech(i);
                    if (o || (o = An.getComponent(i)), o) {
                        if (o.isSupported() && (e = o.canPlayType(t))) return e
                    } else Qe.error('The "' + i + '" tech is undefined. Skipped browser support check for that tech.')
                }
                return ""
            }, e.prototype.selectSource = function(t) {
                var e = this,
                    n = this.options_.techOrder.map(function(t) {
                        return [t, Xr.getTech(t)]
                    }).filter(function(t) {
                        var e = t[0],
                            n = t[1];
                        return n ? n.isSupported() : (Qe.error('The "' + e + '" tech is undefined. Skipped browser support check for that tech.'), !1)
                    }),
                    r = function(t, e, n) {
                        var r = void 0;
                ...
                this.paused() && (this.autoplay() || this.options_.autoplay) && Me && !Se && this.play()
                ...
                return void 0 === t ? this.error_ || null : null === t ? (this.error_ = t, this.removeClass("vjs-error"), void(this.errorDisplay && this.errorDisplay.close())) : (this.error_ = new st(t), this.addClass("vjs-error"), Qe.error("(CODE:" + this.error_.code + " " + st.errorTypes[this.error_.code] + ")", this.error_.message, this.error_), void this.trigger("error"))
                ...
                var t = void 0,
                    e = void 0,
                    n = void 0,
                    r = yn(this, this.reportUserActivity),
                    i = function(t) {
    ...
    Co.prototype.options_ = {
        techOrder: Xr.defaultTechOrder_,
        html5: {},
        flash: {},
        inactivityTimeout: 2e3,
        playbackRates: [],
        children: ["mediaLoader", "posterImage", "textTrackDisplay", "loadingSpinner", "bigPlayButton", "controlBar", "errorDisplay", "textTrackSettings"],
        language: ko && (ko.languages && ko.languages[0] || ko.userLanguage || ko.language) || "en",
        languages: {},
        notSupportedMessage: "No compatible source was found for this media."
    }, Ie || Co.prototype.options_.children.push("resizeManager"), ["ended", "seeking", "seekable", "networkState", "readyState"].forEach(function(t) {
        Co.prototype[t] = function() {
            return this.techGet_(t)
        }
    }), To.forEach(function(t) {
        Co.prototype["handleTech" + Q(t) + "_"] = function() {
            return this.trigger(t)
        }
    }), An.registerComponent("Player", Co);
    var wo = {},
        Eo = function(t) {
            return wo.hasOwnProperty(t)
        },
        So = function(t) {
            return Eo(t) ? wo[t] : void 0
        },
        xo = function(t, e) {
            ...
            return e.prototype.name = t,
                function() {
                    ...
                    return this[t] = function() {
                        return o
                    }, jo(this, o.getEventHash()), o
                }
        },
        Oo = function() {
            function t(e) {
                if (ze(this, t), this.constructor === t) throw new Error("Plugin must be sub-classed; not directly instantiated.");
                this.player = e, $(this), delete this.trigger, J(this, this.constructor.defaultState), xo(e, this.name), this.dispose = yn(this, this.dispose), e.on("dispose", this.dispose)
            }
            return t.prototype.version = function() {
                ...
                var t = this.name,
                    e = this.player;
                this.trigger("dispose"), this.off(), e.off("dispose", this.dispose), e.activePlugins_[t] = !1, this.player = this.state = null, e[t] = Po(t, wo[t])
            }, t.isBasic = function(e) {
                var n = "string" == typeof e ? So(e) : e;
                return "function" == typeof n && !t.prototype.isPrototypeOf(n.prototype)
            }, t.registerPlugin = function(e, n) {
                if ("string" != typeof e) throw new Error('Illegal plugin name, "' + e + '", must be a string, was ' + (void 0 === e ? "undefined" : Ve(e)) + ".");
                if (Eo(e)) Qe.warn('A plugin named "' + e + '" already exists. You may want to avoid re-registering plugins!');
                ...
                if ("function" != typeof n) throw new Error('Illegal plugin for "' + e + '", must be a function, was ' + (void 0 === n ? "undefined" : Ve(n)) + ".");
                return wo[e] = n, "plugin" !== e && (t.isBasic(n) ? Co.prototype[e] = Ao(e, n) : Co.prototype[e] = Po(e, n)), n
            }, t.deregisterPlugin = function(t) {
                if ("plugin" === t) throw new Error("Cannot de-register base plugin.");
                Eo(t) && (delete wo[t], delete Co.prototype[t])
            }, t.getPlugins = function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : Object.keys(wo),
                    e = void 0;
                return t.forEach(function(t) {
                    var n = So(t);
                    n && (e = e || {}, e[t] = n)
    ...
    Oo.getPlugin = So, Oo.BASE_PLUGIN_NAME = "plugin", Oo.registerPlugin("plugin", Oo), Co.prototype.usingPlugin = function(t) {
        return !!this.activePlugins_ && !0 === this.activePlugins_[t]
    }, Co.prototype.hasPlugin = function(t) {
        return !!Eo(t)
    };
    var Mo = function(t, e) {
            if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function, not " + (void 0 === e ? "undefined" : Ve(e)));
            t.prototype = Object.create(e && e.prototype, {
                constructor: {
                    value: t,
                    enumerable: !1,
        ...
        No = function(t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                ...
                r = {};
            "object" === (void 0 === e ? "undefined" : Ve(e)) ? (e.constructor !== Object.prototype.constructor && (n = e.constructor), r = e) : "function" == typeof e && (n = e), Mo(n, t);
            for (var i in r) r.hasOwnProperty(i) && (n.prototype[i] = r[i]);
            return n
        };
    "undefined" == typeof HTMLVideoElement && h() && (ge.createElement("video"), ge.createElement("audio"), ge.createElement("track"), ge.createElement("video-js"));
    var Io = function(t) {
        return 0 === t.indexOf("#") ? t.slice(1) : t
    };
    if (ae.hooks_ = {}, ae.hooks = function(t, e) {
            return ae.hooks_[t] = ae.hooks_[t] || [], e && (ae.hooks_[t] = ae.hooks_[t].concat(e)), ae.hooks_[t]
        }, ae.hook = function(t, e) {
            ae.hooks(t, e)
        }, ae.hookOnce = function(t, e) {
            ae.hooks(t, [].concat(e).map(function(e) {
                return function n() {
                    return ae.removeHook(t, n), e.apply(void 0, arguments)
                }
            }))
        }, ae.removeHook = function(t, e) {
            var n = ae.hooks(t).indexOf(e);
            return !(n <= -1) && (ae.hooks_[t] = ae.hooks_[t].slice(), ae.hooks_[t].splice(n, 1), !0)
        }, !0 !== pe.VIDEOJS_NO_DYNAMIC_STYLE && h()) {
        var Do = en(".vjs-styles-defaults");
        if (!Do) {
            Do = fn("vjs-styles-defaults");
            var Lo = en("head");
            Lo && Lo.insertBefore(Do, Lo.firstChild), vn(Do, "\n      .video-js {\n        width: 300px;\n        height: 150px;\n      }\n\n      .vjs-fluid {\n        padding-top: 56.25%\n      }\n    ")
        }
    }
    return G(1, ae), ae.VERSION = ce, ae.options = Co.prototype.options_, ae.getPlayers = function() {
        return Co.players
    }, ae.getPlayer = function(t) {
        var e = Co.players,
            n = void 0;
        if ("string" == typeof t) {
            var r = Io(t),
    ...
    }, ae.getAllPlayers = function() {
        return Object.keys(Co.players).map(function(t) {
            return Co.players[t]
        }).filter(Boolean)
    }, ae.players = Co.players, ae.getComponent = An.getComponent, ae.registerComponent = function(t, e) {
        Xr.isTech(e) && Qe.warn("The " + t + " tech was registered as a component. It should instead be registered using videojs.registerTech(name, tech)"), An.registerComponent.call(An, t, e)
    }, ae.getTech = Xr.getTech, ae.registerTech = Xr.registerTech, ae.use = Ut, !Ie && Object.defineProperty ? (Object.defineProperty(ae, "middleware", {
        value: {},
        writeable: !1,
        enumerable: !0
    }), Object.defineProperty(ae.middleware, "TERMINATOR", {
        value: Yr,
        writeable: !1,
        enumerable: !0
    })) : ae.middleware = {
        TERMINATOR: Yr
    }, ae.browser = He, ae.TOUCH_ENABLED = Be, ae.extend = No, ae.mergeOptions = tt, ae.bind = yn, ae.registerPlugin = Oo.registerPlugin, ae.plugin = function(t, e) {
        return Qe.warn("videojs.plugin() is deprecated; use videojs.registerPlugin() instead"), Oo.registerPlugin(t, e)
    }, ae.getPlugins = Oo.getPlugins, ae.getPlugin = Oo.getPlugin, ae.getPluginVersion = Oo.getPluginVersion, ae.addLanguage = function(t, e) {
        var n;
        return t = ("" + t).toLowerCase(), ae.options.languages = tt(ae.options.languages, (n = {}, n[t] = e, n)), ae.options.languages[t]
    }, ae.log = Qe, ae.createTimeRange = ae.createTimeRanges = it, ae.formatTime = re, ae.parseUrl = ir, ae.isCrossOrigin = ar, ae.EventTarget = _n, ae.on = X, ae.one = Y, ae.off = q, ae.trigger = K, ae.xhr = _r, ae.TextTrack = Cr, ae.AudioTrack = kr, ae.VideoTrack = wr, ["isEl", "isTextNode", "createEl", "hasClass", "addClass", "removeClass", "toggleClass", "setAttributes", "getAttributes", "emptyEl", "appendContent", "insertContent"].forEach(function(t) {
        ae[t] = function() {
            return Qe.warn("videojs." + t + "() is deprecated; use videojs.dom." + t + "() instead"), rn[t].apply(null, arguments)
        }
